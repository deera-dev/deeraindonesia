/**
 * HPPFilterModal.jsx — Filter full-screen bottom-sheet untuk grid Template
 * HPP (ProduksiHPPPage, tab "Template HPP"). Pola & styling sama persis
...
export default function HPPFilterModal({ draft, onChange, previewCount, onApply, onReset, onClose }) {
  return (
    <div className="fixed inset-0 z-50 flex items-end md:items-center justify-center bg-black/60 backdrop-blur-sm">
      ...
      <div className="relative bg-skin-card w-full max-w-lg h-[100dvh] md:h-auto md:max-h-[90dvh] flex flex-col border-t-2 md:border-2 border-skin-bdr shadow-xl">
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-5">
          <div>
            <label className={labelCls}>Rentang Total HPP</label>
