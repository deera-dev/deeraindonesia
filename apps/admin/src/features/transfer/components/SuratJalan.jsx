...
function SuratJalanContent({ transfer }) {
  ...
  const sc = STATUS_CONFIG[transfer.status] ?? {
    bg: "#F5F5F5",
    border: "#CCC",
    text: "#333",
  ...
  return (
    ...
    >
      ...
      {/* ── TABEL BARANG ── */}
      <table
        style={{ width: "100%", borderCollapse: "collapse", marginBottom: 16, fontSize: 11.5 }}
      >
        <thead>
              ...
              <>
                ...
                {kodeItems.map((item, idx) => (
                  ...
                  >
                    ...
                    <td style={{ padding: "6px 10px", color: "#666", textTransform: "uppercase" }}>
                      {item.warna && item.warna !== "_" ? item.warna : "—"}
                    </td>
                    <td
                      style={{
                        padding: "6px 10px",
        ...
        <tfoot>
          <tr style={{ background: "#1a1a1a", color: "#fff" }}>
            ...
            <td style={{ padding: "9px 10px", textAlign: "right", fontWeight: 900, fontSize: 17 }}>
              {totalQty}
            </td>
          </tr>
        </tfoot>
