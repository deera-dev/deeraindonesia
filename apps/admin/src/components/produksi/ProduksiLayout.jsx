...
export default function ProduksiLayout({ children, title }) {
  ...
  return (
    <div className="min-h-screen bg-skin-page text-skin-text">
      {/* ── Header ── */}
      <header className="sticky top-0 z-30 bg-skin-card border-b-2 border-skin-bdr shadow-sm">
        <div className="flex items-center justify-between gap-3 px-4 py-4 md:px-8">
          <div className="flex items-center gap-4 min-w-0">
            <Link
              to="/admin"
              className="font-editorial text-xs tracking-[0.2em] uppercase text-skin-text3 hover:text-[#CAB170] transition shrink-0"
            >
              ← Admin
            </Link>
            <div className="w-px h-5 bg-skin-bdr shrink-0" />
