...
const inputCls =
  "w-full bg-transparent border border-white/15 px-3 py-2 text-white font-editorial text-sm tracking-wide focus:outline-none focus:border-white/50 disabled:opacity-40 placeholder:text-white/20 transition";
const labelCls =
  "block font-editorial text-[10px] tracking-[0.3em] text-white/50 mb-2 uppercase";
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center p-2 overflow-y-auto bg-black/80 backdrop-blur-sm md:p-10">
      <form
        ...
        className="relative w-full max-w-2xl p-4 my-auto bg-black border border-white/20 md:p-10"
      >
        <button
          type="button"
          onClick={onClose}
        ...
        <div className="mb-6">
          ...
          <input
            ...
            disabled={saving}
            placeholder="Auora burkat mix jasmin"
            className={inputCls}
          />
        </div>
        ...
        {errMsg && (
          <p className="mb-4 font-editorial text-xs text-red-400">{errMsg}</p>
        )}
