    ...
    <div className="mb-8">
          ...
          return (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <p className={`font-editorial text-base tracking-[0.1em] uppercase font-medium ${isActive ? "text-skin-text" : "text-skin-text3"}`}>
                  {preset.size}
                </p>
                <p className="font-editorial text-sm text-skin-text3">LD {preset.ld} · PB {preset.pb} cm</p>
              </div>
      ...
      {activeSet.size > 0 && (
        <div className="mt-4 p-4 border-2 border-skin-bdr-gold bg-skin-gold">
          <p className="font-editorial text-xs tracking-[0.2em] text-skin-text3 mb-2 uppercase">Preview WA:</p>
