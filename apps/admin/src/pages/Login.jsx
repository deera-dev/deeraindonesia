    ...
    <main className="min-h-screen bg-skin-page flex items-center justify-center px-6">
      <div className="w-full max-w-sm">
        <div className="mb-10 text-center">
          <p className="font-editorial tracking-[0.3em] text-skin-text3 text-sm uppercase mb-3">Admin</p>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          <div className="flex flex-col gap-2">
            <label className="font-editorial text-skin-text2 text-sm tracking-[0.2em] uppercase">Username</label>
            <input
              type="text" value={username}
              onChange={(e) => setUsername(e.target.value)}
              autoComplete="username" autoCapitalize="none" required
              className="bg-skin-card border-2 border-skin-bdr text-skin-text px-4 py-3.5 font-editorial text-base rounded-none outline-none focus:border-[#CAB170] transition text-lg"
            />
          </div>
          <div className="flex flex-col gap-2">
            <label className="font-editorial text-skin-text2 text-sm tracking-[0.2em] uppercase">Password</label>
            <input
