  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 hidden md:flex md:flex-col md:justify-end md:pb-24 md:pl-20">
        <p className="font-headline text-[#cab170] text-[52px] leading-none">{model.kode}</p>
      ...
      <div className="absolute bottom-0 left-0 z-10 w-full md:hidden">
        <div className="pt-40 pb-16 bg-gradient-to-t from-black via-black/50 to-transparent px-7">
          <p className="font-headline text-[#cab170] text-[30px] leading-none">{model.kode}</p>
          <p className="mt-2 font-script text-white/55 text-xl leading-tight">{model.nama}</p>
          {sizeNames.length > 0 && (
