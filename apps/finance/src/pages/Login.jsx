    ...
    <main className="min-h-screen bg-skin-page flex items-center justify-center px-6">
      <div className="w-full max-w-sm">
        <div className="mb-10 text-center">
          <p className="font-editorial tracking-[0.3em] text-skin-text3 text-sm uppercase mb-3">
            Finance
          </p>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          <div className="flex flex-col gap-2">
            ...
            <input
              ...
              autoCapitalize="none"
              required
              className="bg-skin-card border-2 border-skin-bdr text-skin-text px-4 py-3.5 font-editorial text-base rounded-none outline-none focus:border-[#CAB170] transition"
            />
          </div>
          <div className="flex flex-col gap-2">
            <label className="font-editorial text-skin-text2 text-sm tracking-[0.2em] uppercase">
          ...
          <button
            ...
            className="mt-2 bg-[#CAB170] text-white py-4 font-editorial text-base tracking-[0.25em] uppercase hover:bg-[#A8925A] transition disabled:opacity-50"
          >
            {loading ? "Masuk..." : "Masuk"}
          </button>
        </form>
