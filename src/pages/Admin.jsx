      ...
      <header className="sticky top-0 z-30 border-b bg-black/95 backdrop-blur border-white/10">
        <div className="flex items-center justify-between gap-3 px-4 py-4 md:px-12">
          ...
          <div className="hidden md:flex items-center gap-2">
            ...
            <Link to="/catalog" className="px-4 py-2 font-editorial text-[10px] tracking-[0.25em] uppercase text-white/60 border border-white/15 hover:border-white/50 hover:text-white transition">
              Katalog
            </Link>
