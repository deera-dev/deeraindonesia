  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center">
      ...
      <div className="relative z-10 w-[90%] max-w-md bg-black text-white p-6 border border-white/15">
        <button onClick={onClose} className="absolute top-4 right-4 text-white/40 hover:text-white transition text-lg leading-none">
          &#x2715;
        </button>
        ...
        <div className="mb-6 space-y-5 font-editorial text-sm text-white/65 leading-relaxed">
          <div>
            <p className="mb-1.5 font-editorial text-[10px] tracking-[0.25em] text-[#cab170]/80 uppercase">Pasar Tasik Cideng</p>
            <p>
          ...
          <div>
            <p className="mb-1.5 font-editorial text-[10px] tracking-[0.25em] text-[#cab170]/80 uppercase">Pasar Sandang Tegalgubug Cirebon</p>
            <p>
